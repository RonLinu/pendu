...
(function() {
  ...
  var askConfirm, create_keyboard, generate_new_word, guess, new_word, reveal, reveal_word, showAlert, show_labels, sleep, state;
  ...
  create_keyboard = function() {
    ...
    rows = [['Q', 'W', 'E', 'R', 'T', 'Y', 'U', 'I', 'O', 'P'], ['A', 'S', 'D', 'F', 'G', 'H', 'J', 'K', 'L'], ['Z', 'X', 'C', 'V', 'B', 'N', 'M'], ['COMMENCER', 'RÉVÉLER MOT', 'AU SUJET']];
    ...
    createKey = function(letter) {
      ...
      if (letter.length === 1 || letter === 'RÉVÉLER MOT') {
...
// Generate keys row-wise
  ...
  guess = function(letter) {
    ...
    if (state.failsCounter === 10) {
      ...
      return (async function() {        //~ await sleep 250
