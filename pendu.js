...
var askConfirm, create_keyboard, generate_new_word, guess, new_word, play, reveal, reveal_word, showAlert, show_labels, sleep, state;
...
guess = function(letter) {
  ...
  if (state.failsCounter === 10) {
    ...
    return showAlert('Hélas!', 'info', 'center', `Vous avez  perdu.<br><br>Le mot caché était: ${state.hiddenWord}`);
