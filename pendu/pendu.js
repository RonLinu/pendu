...
(async function() {
  var askConfirm, create_keyboard, generate_new_word, guess, new_word, reveal, reveal_word, showAlert, sleep, state, update_labels,
    indexOf = [].indexOf;
...
// Generate keys row-wise
  ...
  guess = async function(letter) {
    ...
    if (indexOf.call(state.triedLetters, letter) >= 0) {
      return;
    }
